...
public class MealTestData {
    ...
    public static final List<Meal> mealList = Arrays.asList(userMeal7, userMeal6, userMeal5, userMeal4, userMeal3, userMeal2, userMeal1);
    ...
    public static Meal getUpdated() {
        ...
        updated.setDateTime(userMeal1.getDateTime().minusHours(2));
